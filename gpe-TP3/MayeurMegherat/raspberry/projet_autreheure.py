...
estDedans = True
posMaison = [43.633024, 3.86302892]
...
def estMaison():
    pos = getPos()
    estMaison = True
    if float(pos[0]) > posMaison[0] + 0.02 or float(pos[0]) < posMaison[0] - 0.02:
        estMaison = False
    elif float(pos[1]) > posMaison[1] + 0.02 or float(pos[1]) < posMaison[1] - 0.02:
        estMaison = False
    return estMaison
